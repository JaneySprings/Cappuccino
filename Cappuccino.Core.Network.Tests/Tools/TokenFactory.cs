...
public static class TokenFactory {
    ...
    public static AccessToken ValidUnlimited => new(HashFromAssemblyName(), 0, 0);
    ...
    public static AccessToken ValidUnlimitedTokenForUser(int id) => new(HashFromAssemblyName(), 0, id);
